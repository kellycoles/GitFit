        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Biometric_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Biometric",
                columns: new[] { "BiometricId", "Age", "Height", "Sex", "UserId", "Weight" },
                values: new object[] { 1, 52, 66, "female", "00000000-ffff-ffff-ffff-ffffffffffff", 130 });
            ...
            migrationBuilder.InsertData(
                table: "Activity",
                columns: new[] { "ActivityId", "Duration", "EntryId", "Intensity", "Type", "UserId" },
                values: new object[] { 1, 30, 1, "moderate", "walking", "00000000-ffff-ffff-ffff-ffffffffffff" });
